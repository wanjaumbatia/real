...
class OfficeController extends Controller
{
    ...
    public function index()
    {
        $data = DB::select("select 
            ...
            IFNULL((select sum(credit) from payments where status = 'confirmed' and 'reconciled'='0' transaction_type='withdrawal' and remarks='POF' and created_by=u.name),0) as pof,
