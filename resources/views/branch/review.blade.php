...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="card mt-3">
                <div class="card-header">Review Comments</div>
                <div class="card-body">
                    <form action="/save_review" method="POST">
                        @csrf
                        <div class="form-group">
                            <input value="{{$loan->id}}" hidden name="id" />
                            <label for="">Cumulative Remarks</label>
                            <Textarea class="form-control" rows="3" name="comment"></Textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Action Plan</label>
                            <Textarea class="form-control" rows="3" name="action_plan"></Textarea>
                        </div>
